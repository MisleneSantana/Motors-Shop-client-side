...
interface IBaseTextsProps {
  children: ReactNode;
  tag: 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'span' | 'p' | 'i';
  className?: string;
}

export const BaseTexts = ({ children, tag, className }: IBaseTextsProps) => (
  <>
    ...
    {tag === 'i' && <span className={className}>{children}</span>}
  </>
);
